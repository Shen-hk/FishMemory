...
class BlockEditorOperations(
    ...
    private fun handleVideoBlockRetry(blockId: String) {
        ...
        adapter.videoUploadManager?.enqueueUpload(
            blockId,
            localUri,
            object : VideoUploadManager.UploadCallback {
    ...
    fun configureAiAssistCallbacks(
        ...
        adapter.onAiSparkleClick = onSparkle
        adapter.onAiAccept = onAccept
        adapter.onAiRetry = onRetry
        adapter.onAiDiscard = onDiscard
    }
